...
<div class="flex min-h-screen flex-col bg-[var(--bg-base)] text-[var(--text)]">
	...
	<main id="main-content" class="flex-1 pt-4 transition-[margin] duration-200 ease-out {sidebarOpen ? 'lg:ml-64' : ''}">
	...
	{#if !hideFooter}
		<footer class="transition-[margin] duration-200 ease-out pb-4 pt-8 text-center text-xs text-[var(--text-muted)] opacity-60 {sidebarOpen ? 'lg:ml-64' : ''}" data-testid="app-footer">
